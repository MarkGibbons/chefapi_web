function nodeEdit (org, node) {
  ...
  request.onload = function () {
    ...
    // RunList:[]
    var rl = JSON.stringify(nodeinfo.run_list)
    ...
    var aa = JSON.stringify(nodeinfo.automatic_attributes)
    ...
    var na = JSON.stringify(nodeinfo.normal_attributes)
    ...
    var da = JSON.stringify(nodeinfo.default_attributes)
    ...
    var oa = JSON.stringify(nodeinfo.override_attributes)
