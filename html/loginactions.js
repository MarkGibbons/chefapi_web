function signinFunction() {
  ...
  request.open('POST', 'http://localhost:8113/signin', true);
...
function refreshFunction() {
  ...
  var request = new XMLHttpRequest();
  request.open('POST', 'http://localhost:8113/refresh', false);
  request.send();
...
function welcomeFunction() {
  var request = new XMLHttpRequest();
  request.open('GET', 'http://localhost:8113/welcome', false);
