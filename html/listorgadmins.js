function orgadminsListFunction () {
  ...
  request.open('GET', 'https://localhost:8143/orgadmins' + '?user=' + filters.user + '&organization=' + filters.organization, true)
  ...
  request.onload = function () {
    ...
    html += '<tr>'
    html += '<td class=orgusers><b>ORG ADMINS</b></td>'
    html += '</tr>'
